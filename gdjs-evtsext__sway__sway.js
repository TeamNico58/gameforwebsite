...
{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setAngleLeft(eventsFunctionContext.getArgument("AngleLeftChanged"));
}
}{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setAngleRight(eventsFunctionContext.getArgument("AngleRightChanged"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setAngleTimeMin(eventsFunctionContext.getArgument("AngleTimeMinChanged"));
}
}{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayAngleTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setAngleTimeMax(eventsFunctionContext.getArgument("AngleTimeMaxChanged"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setYScaleMin(eventsFunctionContext.getArgument("YScaleMinChanged"));
}
}{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setYScaleMax(eventsFunctionContext.getArgument("YScaleMaxChanged"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setYScaleTimeMax(eventsFunctionContext.getArgument("YScaleTimeMaxChanged"));
}
}{for(var i = 0, len = gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Sway__Sway.Sway.prototype.ChangeSwayYScaleTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setYScaleTimeMin(eventsFunctionContext.getArgument("YScaleTimeMinChanged"));
}
}}
